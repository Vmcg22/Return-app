                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 form-group">
                            <div>
                                ...
                                <label class="mandatory-field">*</label>
                                <input type="text" class="form-control {{$errors->has('unit_price') ? 'is-invalid' : ''}}" 
                                name="unit_price" id="unit_price" value="{{old('unit_price', 0)}}">
                    ...
                    <div class="row">
                        <div class="col-lg-12 form-group">
                            <div>
                                ...
                                <textarea class="form-control" name="description" id="description" rows="3" value=" {{old('description', 0)}} "></textarea>
                            </div>
                        </div>
                    </div>
